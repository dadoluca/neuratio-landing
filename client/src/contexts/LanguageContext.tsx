...
const translations = {
  en: {
    ...
    'toast.error': 'Error',
    'toast.errorDesc': 'Failed to submit your request. Please send an email directly to info@neuratio.ai',
  ...
  it: {
    ...
    'toast.error': 'Errore',
    'toast.errorDesc': 'Impossibile inviare la tua richiesta. Perfavore mandare direttamente una mail a info@neuratio.ai',
